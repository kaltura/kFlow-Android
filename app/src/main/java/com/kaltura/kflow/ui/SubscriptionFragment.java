 ...
 */
public class SubscriptionFragment extends DebugFragment implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.get: {
                makeGetVodRequest(mPackageAssetType.getText().toString());
                break;
            }
        }
    }

    private void makeGetVodRequest(String packageType) {
